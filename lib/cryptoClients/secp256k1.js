...
var _reactNativeKeyEncoder = require('react-native-key-encoder');

var _reactNativeKeyEncoder2 = _interopRequireDefault(_reactNativeKeyEncoder);
...
var SECP256K1Client = exports.SECP256K1Client = function () {
  ...
  _createClass(SECP256K1Client, null, [{
    ...
    value: function createHash(signingInput) {
      return (0, _reactNativeCrypto.createHash)('sha256').update(signingInput).digest();
    }
  }, {
    key: 'loadPrivateKey',
